  ...
  return (
    <div>
        <form onSubmit={handleSubmit(onSubmit)}>
            <input type='text' className='name' placeholder='Full Name...' {...register('fullName')}/>
            <p>{errors.fullName?.message}</p>

            <input type='text' className='email' placeholder='Email...' {...register('email')}/>
            <p>{errors.email?.message}</p>
            
            <input type='text' className='phone' placeholder='Mobile Number...' {...register('mobileNumber')}/>
            <p></p>
            <input type='number' className='age' placeholder='Age...'{...register('age')}/>
            <p>{errors.age?.message}</p>

            <input type='password' className='password' placeholder='Password...' {...register('password')}/>
            <p>{errors.password?.message}</p>

            <input type='password' className='cnfpass' placeholder='Confirm Password...' {...register('confirmPassword')}/>
